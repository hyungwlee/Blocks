...
class BLShapeNode2x2: BBoxNode {
   ...
   private let availableAssets = [
        ...
        "Group 16309-1", "Group 16309", "Group 16310", "Group 16312-1", "Group 16313", "Group 16314-1", "Surprised" ,"Group 16363-1"
    ]
    

    
    // Now directly selecting a specific asset (e.g., "Laughing-1")
    private let selectedAsset = "Surprised"  // Choose the asset you want
